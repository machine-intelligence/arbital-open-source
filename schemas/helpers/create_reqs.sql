...
(pageId,currentEdit,maxEdit,createdAt,type,sortChildrenBy,createdBy)
VALUES
(111111111111000000,1,1,now(),"wiki","likes",1),
(111111111111000001,1,1,now(),"wiki","likes",1),
(111111111111000002,1,1,now(),"wiki","likes",1),
(111111111111000003,1,1,now(),"wiki","likes",1),
(111111111111000004,1,1,now(),"wiki","likes",1),
(111111111111000005,1,1,now(),"wiki","likes",1),
(111111111111000006,1,1,now(),"wiki","likes",1),
(111111111111000007,1,1,now(),"wiki","likes",1),
(111111111111000008,1,1,now(),"wiki","likes",1),
(111111111111000009,1,1,now(),"wiki","likes",1),
(111111111111000010,1,1,now(),"wiki","likes",1)
;
