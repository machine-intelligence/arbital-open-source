...
for s in answers.sql comments.sql commentLikes.sql likes.sql links.sql pages.sql pageTagPairs.sql subscriptions.sql tags.sql updates.sql visits.sql votes.sql; do
