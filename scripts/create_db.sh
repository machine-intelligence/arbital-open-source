...
for s in answers.sql comments.sql commentLikes.sql likes.sql links.sql pages.sql pageTagPairs.sql subscriptions.sql tags.sql updates.sql users.sql visits.sql votes.sql; do
#for s in pages.sql; do
