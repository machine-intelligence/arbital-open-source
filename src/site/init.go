...
func init() {
	...
	r.HandleFunc("/json/intrasitePopover/", handlerWrapper(intrasitePopoverJsonHandler)).Methods("POST")
	r.HandleFunc("/json/lens/", handlerWrapper(lensJsonHandler)).Methods("POST")
	...
	r.HandleFunc("/json/primaryPage/", handlerWrapper(primaryPageJsonHandler)).Methods("POST")
