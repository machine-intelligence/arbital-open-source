...
func init() {
	...
	s.HandleFunc(deleteInviteHandler.URI, handlerWrapper(deleteInviteHandler)).Methods("POST")
	...
	s.HandleFunc(sendInviteHandler.URI, handlerWrapper(sendInviteHandler)).Methods("POST")
